...
const DEFAULT_PROMPT_HEADER_IMAGE =
...
const DEFAULT_PROMPT_HEADER_CHAT =
    "You are a helpful assistant which will help user to generate some potential food recipes based on the user's input: \n" +
    "For the recipe generation you need to follow the following rules: \n" +
    "1. The title of the recipe \n" +
    "2. The ingredients of the recipe \n" +
    "3. The steps to prepare the recipe \n" +
